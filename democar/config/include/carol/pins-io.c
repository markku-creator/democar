...
static os_short pins_outputs_RIGHT_prm[]= {PIN_RV, PIN_RV};
static os_short pins_outputs_LEFT_prm[]= {PIN_RV, PIN_RV};
static os_short pins_outputs_FORWARD_prm[]= {PIN_RV, PIN_RV};
static os_short pins_outputs_BACKWARD_prm[]= {PIN_RV, PIN_RV};
